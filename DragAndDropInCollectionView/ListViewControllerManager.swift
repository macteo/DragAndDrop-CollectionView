...
class ListViewControllerManager : UIViewController {
    ...
    override func viewDidLoad() {
        ...
        leadingListViewController.manager = self
        ...
        listControllers.append(leadingListViewController)
        ...
        trailingListViewController.manager = self
        ...
        listControllers.append(trailingListViewController)
    }
}

extension ListViewControllerManager: ListManager {
    ...
    func transferItems(coordinator: UICollectionViewDropCoordinator, destinationIndexPath: IndexPath, collectionView: UICollectionView, listController: ListController)
    {
        for (index, item) in coordinator.items.enumerated()
        {
            ...
            if let sourceIndex = sourceListIndex, listControllers.count > sourceIndex {
                ...
                if let indexOf = sourceController.items.index(where: { $0.name == localObject.name }) {
